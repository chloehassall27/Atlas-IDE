...
namespace AtlasIDE
{
    ...
    { 
        ...
        void ShowRelEdit(bool show) // Controller that hides or shows edit form
        {
            ...
            System.Windows.Controls.TextBox[] textBoxes = { tbRelName, tbRelOwn, tbRelDescription, tbRelThing, tbRelSpace, tbRelFirst, tbRelSec, tbRelFirstArgs, tbRelSecArgs };
            ...
            if (show) // Show Relationship edit form
            {
                ...
                cbRelType.Visibility = Visibility.Visible;
                ...
                cbRelType.SelectedItem = rel.Type;
            ...
            else // Don't show
            {
                ...
                cbRelType.Visibility = Visibility.Hidden;
        ...
        public void Relfilter()
        {
            if (thingsRelFIlter.SelectedItems.Count > 0)
                view.Filter = (o) =>
                {
                    return thingsRelFIlter.SelectedItems.Contains(((Relationship)o).ThingID);
                };
            else
                view.Filter = null;
        }

        private void RelfilterChangeSelection(object sender, SelectionChangedEventArgs e)
        {
            Relfilter();
        }
